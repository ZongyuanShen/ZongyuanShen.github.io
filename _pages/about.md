...
- **Motion Replanning:** generates new paths in response to the changes in the environment using current observations (reactive strategy) or predicted information of dynamic obstacles (proactive strategy) for uninterrupted safe navigation.
- **Coverage Path Planning:** generates paths to visit all points in an area of interest and perform tasks such as environment monitoring, seabed mapping, and structure inspection in the unknown environments.
