...
3. **Proactive replanning:** How to model the behavior of dynamic obstacles, predict their futures states, and exploit these information for time-risk optimal motion planning in the spatio-temporal domain.
